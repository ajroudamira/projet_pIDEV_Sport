...
public class Mailing {
    ...
    private static final String FROM_EMAIL = "chouikhamedaziz@gmail.com";
    private static final String PASSWORD = "akvc igyw dpyn vpok";
    private static final String SMTP_HOST = "smtp.gmail.com";
    private static final int SMTP_PORT = 587;

    public static void sendHtmlNotification(String toEmail, String subject, String product) {
